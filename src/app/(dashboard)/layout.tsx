...
import DashboardInteractions from '@/src/shared/component/dashboardInteractions/page'
...
import { VscBracketError, VscGithubProject } from 'react-icons/vsc';
import { CgPerformance, CgSearch } from 'react-icons/cg';
import { GrSettingsOption } from 'react-icons/gr';
import { SiUptimekuma } from 'react-icons/si';
import { TbApi, TbAlertSquare } from 'react-icons/tb';
    ...
    return (
        <>
            <div className="antialiased bg-gray-50 dark:bg-gray-900">
                    ...
                    <div className="flex flex-wrap justify-between items-center">
                        ...
                        <div className="flex items-center lg:order-2">
                            ...
                            <div className="relative">
                                ...
                                <div
                                    className="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg  right-0 dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
                            ...
                            <div className='relative'>
                                ...
                                <div
                                    className="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl right-0"
                                    id="dropdown"
                                >
                ...
                {/* Sidebar */}
                <aside
                    className="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700 py-5 bg-white dark:bg-gray-800"
                    aria-label="Sidenav"
                        ...
                        <Sidebar aria-label="Sidebar with multi-level dropdown example">
                            <SidebarItems className='py-5'>
                                <SidebarItemGroup>
                                    ...
                                    >
                                        <SidebarItem href="/projects">All Projects</SidebarItem>
                                        <SidebarItem href="#">Add New Project</SidebarItem>
                                        <SidebarItem href="#">Refunds</SidebarItem>
                                        <SidebarItem href="#">Shipping</SidebarItem>
                                    </SidebarCollapse>
                                    <SidebarItem href="#" icon={VscBracketError}>
                                        Error
                                    </SidebarItem>
                                    <SidebarItem href="#" icon={GrSettingsOption}>
                                        Settings
                                    </SidebarItem>
                                    <SidebarItem href="#" icon={CgPerformance}>
                                        Performance
                                    </SidebarItem>
                                    <SidebarItem href="#" icon={TbApi}>
                                        API Failures
                                    </SidebarItem>
                                    <SidebarItem href="#" icon={SiUptimekuma}>
                                        Uptime
                                    </SidebarItem>
                                    <SidebarItem href="#" icon={TbAlertSquare}>
                                        Alerts
                                    </SidebarItem>
                                </SidebarItemGroup>
                            </SidebarItems>
